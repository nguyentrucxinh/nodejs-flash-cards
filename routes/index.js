...
router.get('/api/cards/first', catchErrors(cardEndpoint.getCardFirst))
router.get('/api/cards/next/:id', catchErrors(cardEndpoint.getCardNextById))
router.get('/api/cards/prev/:id', catchErrors(cardEndpoint.getCardPrevById))
